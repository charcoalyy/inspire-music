...
const Lessons = () => {
    ...
    const categories = [
      ...
      <section className="lesson-categories">
          <InfoCard iden="lessons/instrumental" title="Instrumental" extraDesc="Recommended for ages 5+" desc="Includes piano, violin, voice, guitar, and drum. Regardless of level, students benefit from a teacher’s dedicated attention. Personalized lessons help your child take their study to the next level." image="https://media.wired.co.uk/photos/606db5661dcb46afc3a1e030/4:3/w_1704,h_1278,c_limit/instrument1.jpg"/>
          <InfoCard iden="lessons/theory" title="Music Theory" extraDesc="Recommended for ages 7+" desc="Includes all RCM theory levels. From beginners to advanced learners, students will participate in group theory lessons based their approximate level and age." image="https://becomeabassist.com/wp-content/uploads/2013/05/sheet_music.jpg"/>
