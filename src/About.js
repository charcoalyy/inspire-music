...
const About = () => {
    return(
        <div className="about">
            <Banner title="About Inspire Music" desc="Who we are – What we were built from – What we strive towards" id="about-banner" noButton={true} />
            ...
            <section className="about-section right-image">
                <div className="about-content">
                    ...
                    <p>Alongside providing the sincere tools, instruction, and community needed to promote lifelong musical talent, we put emphasis on ensuring that our students become well-rounded.</p>
                    <p>Our concerts, events, and camps, on top of regular lessons, enable our students to develop their planning abilities, public speaking skills, sense of teamwork, and ambition.</p>
                </div>
                <div className="about-thumb">
